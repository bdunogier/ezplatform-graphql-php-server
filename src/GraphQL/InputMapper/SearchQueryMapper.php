 ...
 */
namespace App\GraphQL\InputMapper;
...
class SearchQueryMapper
{
     ...
     *
     * @return \App\eZ\Platform\API\Repository\Values\Content\Query
     */
     ...
     * @param $dateMetadata
     *
     * @return \App\eZ\Platform\API\Repository\Values\Content\Query\Criterion\DateMetadata[]
     */
    ...
    private function mapInputToFieldCriterion($input)
    {
        ...
        foreach ($operators as $opString) {
            if (isset($input[$opString])) {
                ...
                $operator = constant('App\eZ\Platform\API\Repository\Values\Content\Query\Criterion\Operator::' . strtoupper($opString));
            }
        }
