...
/**
 * File containing the eZ\Platform\API\Repository\ContentTypeService class.
 *
...
use App\eZ\Platform\API\Repository\Values\ContentType\ContentTypeCreateStruct;
...
interface ContentTypeService
{
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to create a content type group
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If a group with the same identifier already exists
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeGroupCreateStruct $contentTypeGroupCreateStruct
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\NotFoundException If group can not be found
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to create a content type group
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If the given identifier (if set) already exists
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeGroup $contentTypeGroup the content type group to be updated
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeGroupUpdateStruct $contentTypeGroupUpdateStruct
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to delete a content type group
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If  a to be deleted content type has instances
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeGroup $ContentTypeGroup
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to create a content type
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException In case when
     ...
     * @throws \eZ\Platform\API\Repository\Exceptions\ContentTypeFieldDefinitionValidationException
     *         if a field definition in the $contentTypeCreateStruct is not valid
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeCreateStruct $contentTypeCreateStruct
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeGroup[] $contentTypeGroups Required array of
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\NotFoundException If a content type with the given id and status DEFINED can not be found
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\NotFoundException If content type with the given identifier and status DEFINED can not be found
     *
     ...
     * Get a Content Type object by id.
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\NotFoundException If content type with the given remote id and status DEFINED can not be found
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\NotFoundException If the content type draft owned by the current user can not be found
     *
     * @param mixed $contentTypeId
     *
     * @return \App\eZ\Platform\API\Repository\Values\ContentType\ContentTypeDraft
     ...
     * @param string[] $prioritizedLanguages Used as prioritized language code on translated properties of returned object.
     *
     * @return \App\eZ\Platform\API\Repository\Values\ContentType\ContentType[]|iterable
     */
     ...
     * @param string[] $prioritizedLanguages Used as prioritized language code on translated properties of returned object.
     *
     * @return \App\eZ\Platform\API\Repository\Values\ContentType\ContentType[] an array of {@link ContentType} which have status DEFINED
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to edit a content type
     * @throws \eZ\Platform\API\Repository\Exceptions\BadStateException If there is already a draft assigned to another user
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to update a content type
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If the given identifier or remoteId already exists.
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeDraft $contentTypeDraft
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeUpdateStruct $contentTypeUpdateStruct
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\BadStateException If there exist content objects of this type
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to delete a content type
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentType $contentType
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the current-user is not allowed to copy a content type
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentType $contentType
     * @param \eZ\Platform\API\Repository\Values\User\User $creator If null the current-user is used instead
     *
     * @return \App\eZ\Platform\API\Repository\Values\ContentType\ContentType
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to unlink a content type
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If the content type is already assigned the given group
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentType $contentType
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeGroup $contentTypeGroup
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to link a content type
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If the content type is not assigned this the given group.
     * @throws \eZ\Platform\API\Repository\Exceptions\BadStateException If $contentTypeGroup is the last group assigned to the content type
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentType $contentType
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeGroup $contentTypeGroup
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException if the identifier in already exists in the content type
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to edit a content type
     * @throws \eZ\Platform\API\Repository\Exceptions\ContentTypeFieldDefinitionValidationException
     *         if a field definition in the $contentTypeCreateStruct is not valid
     * @throws \eZ\Platform\API\Repository\Exceptions\BadStateException If field definition of the same non-repeatable type is being
     ...
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeDraft $contentTypeDraft
     * @param \eZ\Platform\API\Repository\Values\ContentType\FieldDefinitionCreateStruct $fieldDefinitionCreateStruct
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If the given field definition does not belong to the given type
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to edit a content type
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeDraft $contentTypeDraft
     * @param \eZ\Platform\API\Repository\Values\ContentType\FieldDefinition $fieldDefinition
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If the field id in the update struct is not found or does not belong to the content type of
     *                                                                        If the given identifier is used in an existing field of the given content type
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to edit a content type
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeDraft $contentTypeDraft the content type draft
     * @param \eZ\Platform\API\Repository\Values\ContentType\FieldDefinition $fieldDefinition the field definition which should be updated
     * @param \eZ\Platform\API\Repository\Values\ContentType\FieldDefinitionUpdateStruct $fieldDefinitionUpdateStruct
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\BadStateException If the content type has no draft
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If the content type has no field definitions
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to publish a content type
     *
     * @param \eZ\Platform\API\Repository\Values\ContentType\ContentTypeDraft $contentTypeDraft
     */
