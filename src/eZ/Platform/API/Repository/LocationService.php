...
/**
 * File containing the eZ\Platform\API\Repository\LocationService class.
 *
...
interface LocationService
{
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed copy the subtree to the given parent location
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user does not have read access to the whole source subtree
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException if the target location is a sub location of the given location
     *
     * @param \eZ\Platform\API\Repository\Values\Content\Location $subtree - the subtree denoted by the location to copy
     * @param \eZ\Platform\API\Repository\Values\Content\Location $targetParentLocation - the target parent location for the copy operation
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed to read this location
     * @throws \eZ\Platform\API\Repository\Exceptions\NotFoundException If the specified location is not found
     *
     ...
     * @param bool|null $useAlwaysAvailable Respect always available flag on content when filtering on $prioritizedLanguages.
     *
     * @return \App\eZ\Platform\API\Repository\Values\Content\Location[]|iterable
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\BadStateException if there is no published version yet
     *
     * @param \eZ\Platform\API\Repository\Values\Content\ContentInfo $contentInfo
     * @param \eZ\Platform\API\Repository\Values\Content\Location $rootLocation
     * @param string[]|null $prioritizedLanguages Used as prioritized language code on translated properties of returned object.
     *
     * @return \App\eZ\Platform\API\Repository\Values\Content\Location[] An array of {@link Location}
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed to create this location
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException if the content is already below the specified parent
     *                                        or the parent is a sub location of the location of the content
     *                                        or if set the remoteId exists already
     *
     * @param \eZ\Platform\API\Repository\Values\Content\ContentInfo $contentInfo
     * @param \eZ\Platform\API\Repository\Values\Content\LocationCreateStruct $locationCreateStruct
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed to update this location
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException   if if set the remoteId exists already
     *
     * @param \eZ\Platform\API\Repository\Values\Content\Location $location
     * @param \eZ\Platform\API\Repository\Values\Content\LocationUpdateStruct $locationUpdateStruct
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed to swap content
     *
     * @param \eZ\Platform\API\Repository\Values\Content\Location $location1
     * @param \eZ\Platform\API\Repository\Values\Content\Location $location2
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed to hide this location
     *
     * @param \eZ\Platform\API\Repository\Values\Content\Location $location
     *
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed to unhide this location
     *
     * @param \eZ\Platform\API\Repository\Values\Content\Location $location
     *
     * @return \App\eZ\Platform\API\Repository\Values\Content\Location $location, with updated hidden value
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed to move this location to the target
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user does not have read access to the whole source subtree
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException if the new parent is in a subtree of the location
     *
     * @param \eZ\Platform\API\Repository\Values\Content\Location $location
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user is not allowed to delete this location or a descendant
     *
     * @param \eZ\Platform\API\Repository\Values\Content\Location $location
     */
