...
use App\eZ\Platform\API\Repository\Values\User\LookupLimitationResult;
...
interface PermissionResolver
{
     ...
     *
     * @param \eZ\Platform\API\Repository\Values\User\UserReference $userReference
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If module or function is invalid.
     *
     * @param string $module The module, aka controller identifier to check permissions on
     * @param string $function The function, aka the controller action to check permissions on
     * @param \eZ\Platform\API\Repository\Values\User\UserReference|null $userReference User for
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException If any of the arguments are invalid
     * @throws \eZ\Platform\API\Repository\Exceptions\BadStateException If value of the LimitationValue is unsupported
     *
     * @param string $module The module, aka controller identifier to check permissions on
     * @param string $function The function, aka the controller action to check permissions on
     * @param \eZ\Platform\API\Repository\Values\ValueObject $object The object to check if the user has access to
     * @param \eZ\Platform\API\Repository\Values\ValueObject[] $targets An array of location, parent or "assignment" value objects
     *
     * @return bool
     */
     ...
     *
     * @return \App\eZ\Platform\API\Repository\Values\User\LookupLimitationResult
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException
     * @throws \eZ\Platform\API\Repository\Exceptions\BadStateException
     */
