...
/**
 * File containing the eZ\Platform\API\Repository\URLAliasService class.
 *
...
interface URLAliasService
{
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to create url alias
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException if the path already exists for the given language
     *
     ...
     * $alwaysAvailable makes the alias available in all languages.
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to create global
     *          url alias
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException if the path already exists for the given
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the user is not allowed to remove url alias
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException if alias list contains
     *         autogenerated alias
     *
     * @param \eZ\Platform\API\Repository\Values\Content\URLAlias[] $aliasList
     */
     ...
     * @param string $languageCode
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\NotFoundException if the path does not exist or is not valid for the given language
     * @throws \eZ\Platform\API\Repository\Exceptions\InvalidArgumentException if the path exceeded maximum depth level
     *
     * @return \App\eZ\Platform\API\Repository\Values\Content\URLAlias
     */
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\NotFoundException if no url alias exist for the given language
     *
     * @param \eZ\Platform\API\Repository\Values\Content\Location $location
     * @param string $languageCode
     *
