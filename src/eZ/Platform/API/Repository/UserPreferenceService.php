...
use App\eZ\Platform\API\Repository\Values\UserPreference\UserPreference;
use App\eZ\Platform\API\Repository\Values\UserPreference\UserPreferenceList;
...
interface UserPreferenceService
{
     ...
     * Set user preference.
     *
     * @param \eZ\Platform\API\Repository\Values\UserPreference\UserPreferenceSetStruct[] $userPreferenceSetStructs
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException If the current user user is not allowed to set user preference
     ...
     *
     * @return \App\eZ\Platform\API\Repository\Values\UserPreference\UserPreference
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\UnauthorizedException if the current user user is not allowed to fetch user preference
     ...
     *
     * @return \App\eZ\Platform\API\Repository\Values\UserPreference\UserPreferenceList
     */
