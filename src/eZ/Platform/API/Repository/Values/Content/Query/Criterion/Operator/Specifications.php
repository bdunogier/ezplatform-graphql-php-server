...
/**
 * File containing the eZ\Platform\API\Repository\Values\Content\Query\Criterion\Operator\Specifications class.
 *
 * @copyright Copyright (C) eZ Systems AS. All rights reserved.
 * @license For full copyright and license information view LICENSE file distributed with this source code.
 */
namespace App\eZ\Platform\API\Repository\Values\Content\Query\Criterion\Operator;
