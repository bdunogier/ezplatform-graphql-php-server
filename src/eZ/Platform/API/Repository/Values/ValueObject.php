...
/**
 * File containing the eZ\Platform\API\Repository\Values\ValueObject class.
 *
...
use App\eZ\Platform\API\Repository\Exceptions\PropertyNotFoundException;
use App\eZ\Platform\API\Repository\Exceptions\PropertyReadOnlyException;
...
abstract class ValueObject
{
     ...
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\PropertyNotFoundException When property does not exist
     * @throws \eZ\Platform\API\Repository\Exceptions\PropertyReadOnlyException When property is readonly (protected)
     *
     ...
     * @ignore This method is for internal use
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\PropertyNotFoundException exception on all reads to undefined properties so typos are not silently accepted.
     *
     * @param string $property Name of the property
     *
     * @return mixed
     ...
     * @ignore This method is for internal use
     *
     * @throws \eZ\Platform\API\Repository\Exceptions\PropertyNotFoundException exception on all writes to undefined properties so typos are not silently accepted and
     * @throws \eZ\Platform\API\Repository\Exceptions\PropertyReadOnlyException exception on readonly (protected) properties.
     *
     * @uses ::__set()
     *
     * @param string $property Name of the property
