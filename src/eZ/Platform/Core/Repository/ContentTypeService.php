...
use eZ\Publish\Core\REST\Common\Message; use App\eZ\Platform\Core\Repository\Exceptions\InvalidArgumentValue;
...
class ContentTypeService implements APIContentTypeService, Sessionable
{
    ...
    protected function completeContentType(ContentType $contentType)
    {
        ...
        /** @var $referenceList \eZ\Publish\Core\Repository\Values\ContentTypeGroupRefList */
