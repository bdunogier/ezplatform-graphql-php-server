 ...
 */
namespace App\eZ\Platform\Core\Repository\Input\Handler;

use App\eZ\Platform\Core\Repository\Input\Handler;
use App\eZ\Platform\Core\Repository\Exceptions\Parser as ParserException;
...
class Json extends Handler
{
     ...
     *
     * @throw App\eZ\Platform\Core\Repository\Exceptions\Parser
     *
     * @param string $string
     *
     * @return array
